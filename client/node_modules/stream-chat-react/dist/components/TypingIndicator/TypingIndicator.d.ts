...
export declare const TypingIndicator: <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: TypingIndicatorProps<StreamChatGenerics>) => React.JSX.Element | null;
