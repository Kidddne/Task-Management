 ...
 */
export declare const ChannelListMessenger: <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: React.PropsWithChildren<ChannelListMessengerProps<StreamChatGenerics>>) => React.JSX.Element;
